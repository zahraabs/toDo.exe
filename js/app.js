...
function editItem(element) {
  ...
  newInput.value =
    element.parentElement.parentElement.children[0].children[1].innerText;

  element.parentElement.parentElement.children[0].children[1].remove();
  element.parentElement.parentElement.children[0].insertBefore(
    newInput,
    element.parentElement.parentElement.children[0].lastChild
  );
  newInput.focus();
}
...
function closeEditingInput(element) {
  ...
  newLabel.htmlFor =
    element.parentElement.parentElement.children[0].children[0].id;
